...
export const TabletsPage = () => {
  ...
  if (tabletsFromServer) {
    tabletsForShow = [...tabletsFromServer];
  }
  ...
  if (tabletsFromServer && page && perPage) {
    ...
    switch (sort) {
      ...
      //   sortedProducts = productsFromServer.sort((a, b) => b.year - a.year).filter(item => item.category === 'tablets').map(item => ).slice(startItem, endItem)
      //   break;
      default:
