      ...
      >
        <SwiperSlide className="first-screen__slide">
          <Link to={'phones/apple-iphone-14-pro-1tb-gold'}>
            <picture>
              <source
                srcSet="./assets/img/first-slider/first-slider-img-desktop.jpg"
                media="(min-width: 1200px)"
              />
              <source
                srcSet="./assets/img/first-slider/first-slider-img-tablet.jpg"
                media="(min-width: 640px)"
              />
              <img
                src="./assets/img/first-slider/first-slider-img-mobile.jpg"
                alt="main-benefit"
